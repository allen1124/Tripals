...
public class SelectableEventAdapter extends RecyclerView.Adapter<SelectableEventAdapter.ViewHolder> {
    ...
    public SelectableEventAdapter(Activity context){
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        Log.d("CreateTripActivity", "onBindViewHolder: "+position);
        Glide.with(context)
        ...
        holder.eventCard.setBackgroundColor(event.isSelected() ? context.getResources().getColor(R.color.colorPrimary) : Color.WHITE);
        holder.eventCard.setRadius(10);
